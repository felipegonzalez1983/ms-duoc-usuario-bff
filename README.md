...
(Perfiles, preferencias de calzado y direcciones)
...
Estructura del Modelo de Datos (Ejemplo: Productos)
...
Base de Datos: Inicializar MySQL local con el esquema db_usuarios.

Capa DB/BD: Iniciar el proyecto ms-duoc-usuario-bd (Puerto 8082).

Capa BS: Iniciar el proyecto ms-duoc-usuario-bs (Puerto 8081).

Capa BFF: Finalmente, iniciar ms-duoc-usuario-bff (Puerto 8080) para recibir peticiones externas.
