...
| :--- | :--- | :--- | :--- | :--- |
| **Clientes y Usuarios** <br>*(Perfiles, preferencias de calzado y direcciones)* | `ms-duoc-usuario-bff` | BFF (Orquestador) | **8080** | [Ver Repositorio 🔗](https://github.com/felipegonzalez1983/ms-duoc-usuario-bff) | **Clientes y Usuarios** <br>*(Perfiles, preferencias de calzado y direcciones)*
